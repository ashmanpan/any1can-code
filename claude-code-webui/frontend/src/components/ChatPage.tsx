  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto p-3 sm:p-6 h-screen flex flex-col">
              ...
              <nav aria-label="Breadcrumb">
                <div className="flex items-center">
                  ...
                  >
                    ...
                    <span>Cisco Any1can Code Platform</span>
                  </button>
        ...
        {/* AI-Powered Conversational Wizard (Option 2) */}
        {!isHistoryView && !historyError && (
          <ConversationalWizard onSendMessage={(message) => {
            sendMessage(message);
          }} />
        )}

        {/* Optional: Keep old form-based wizard for quick generation
        {!isHistoryView && !historyError && (
          <QuickWizard onSendMessage={(message) => {
            setInput(message);
            sendMessage(message);
          }} />
        )}
